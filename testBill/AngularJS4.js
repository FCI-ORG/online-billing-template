...
(function(p, h, q) {
    ...
    q = k("rp,rt");
    var v = h.extend({}, q, p),
        t = h.extend({}, p, k("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,AccountDetCost,script,section,table,ul")),
        ...
        n = document.createElement("AccountDetCost"),
        M = /^(\s*)([\s\S]*?)(\s*)$/;
...
})(window, window.angular);//# sourceMappingURL=angular-sanitize.min.js.map